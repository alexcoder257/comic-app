<template>
  <div :class="`slider-container before-${currentIndex}`">
    ...
    <div class="background">
      <img :src="mockData[currentIndex].image" alt="img" loading="lazy" />
    </div>
...
import sliderBackground2 from "@/assets/images/sliderBackground2.jpg";
import sliderBackground3 from "@/assets/images/sliderBackground3.jpg";
...
const mockData = ref([
  {
    ...
    image: slider1,
    imageBackground: sliderBackground1,
    description:
  ...
  },
  {
    ...
    title: "ONE PIECE",
    image: slider2,
    imageBackground: sliderBackground2,
    description:
  ...
  },
  {
    ...
    title: "NARUTO",
    image: slider3,
    imageBackground: sliderBackground3,
    description:
